...
export default function Sidebar({
  ...
  return (
    <div
      className={`w-64 flex flex-col shrink-0 border-r border-white/[0.06] fixed inset-y-0 left-0 z-50 md:relative md:flex transition-transform duration-300 transform ${
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 py-5 border-b border-white/[0.05]">
        ...
        <button
          onClick={onClose}
          className="md:hidden ml-auto p-1.5 rounded-lg text-white/50 hover:text-white hover:bg-white/[0.06] transition"
        >
